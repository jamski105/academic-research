...
2. `${CLAUDE_PLUGIN_ROOT}/skills/latex-export/scripts/render_tex.py` → `.tex` (Pandoc bevorzugt, Custom-Fallback)
3. `${CLAUDE_PLUGIN_ROOT}/skills/latex-export/scripts/build_bib.py` → `.bib` aus Vault (alle Papers)
